/**
 * Example usage of the sql-gen package in the electron app
...
// Example: Execute a benchmark test using PowerSync
export async function executeBenchmarkTest(db: any, testFunction: (seed?: number) => { testDescription: string; sqlStatements: string[] }, seed = 42) {
